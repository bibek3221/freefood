                    ...
                    <div className="banner-info">
                      <div className="container">
                        <div className="banner-info-bg">
                          ...
                          <a className="btn btn-style btn-primary mt-sm-5 mt-4 mr-2" href="/about"> Ready
                            to
                            get started?</a>
                        </div>
                      </div>
                    ...
                    <div className="banner-info">
                      <div className="container">
                        <div className="banner-info-bg">
                          ...
                          <p className="mt-4 pr-lg-4">Don't waste your time, check out our productive courses
                          </p>
                          <a className="btn btn-style btn-primary mt-sm-5 mt-4 mr-2" href="/about"> Ready
                            to
                            get started?</a>
            ...
            <div className="container py-lg-5 py-md-4 py-2">
              ...
              <div className="mt-5 text-more">
                <p className="pt-md-3 sample text-center">
                  ...
                  <a href="/courses">View All Courses <span className="pl-2 fa fa-long-arrow-right" /></a>
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="row top-pics">
              <div className="col-md-6">
                <div className="top-pic1">
                  <div className="card-body blog-details">
                    <a href="#blog-single" className="blog-desc">Enhance your educational skills and also experience
              ...
              <div className="col-md-6 mt-md-0 mt-4">
                <div className="top-pic2">
                  <div className="card-body blog-details">
                    <a href="#blog-single" className="blog-desc">Be more productive to be more Successful. Take your
                      first jouney
                    </a>
                    <div className="author align-items-center">
                ...
                <div className="mt-4">
                  <div className="top-pic3">
                    <div className="card-body blog-details">
                      <a href="#blog-single" className="blog-desc"> Our self improvement courses are more
